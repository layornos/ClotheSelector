...
public class Index extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String html = "<html>\n" + 
				...
				"	\t<button class=\"w3-button w3-bar-item\" onclick=\"document.forms[0].submit();\">Search Outfit</button>\n"+
				"	\t<button class=\"w3-button w3-bar-item\" title=\"Add Outfit\" onclick=\"return gotoAddOutfit()\">Add Outfit</button>\n" +
				"	\t<button class=\"w3-button w3-bar-item\" title=\"Show all Outfits\" onclick=\"return gotoAllOutfits()\">Show all Outfits</button>\n" +
				"</div>\n"+
				"</div>\n"+
				"</body>\n" + 
				"</html>";
